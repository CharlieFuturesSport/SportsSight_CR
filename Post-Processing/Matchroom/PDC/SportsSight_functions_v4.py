...
def creative_ocr_proc(creative_ocr, ocrResults, iteration):
    ...
    creative_to_brand = dict(zip(creative_ocr['Creative'], creative_ocr['Brand']))
    creative_to_asset = dict(zip(creative_ocr['Creative'], creative_ocr['Asset']))
    
    filtered_ocr = ocrResults[
        ocrResults['cleaned_text'].isin(creative_ocr['Creative'])
    ].copy()
...
def missing_ocr_proc(brandAsset_method, ocrResults, assetResults, finalResults_combined, sport, iteration, 
        ...
        for filename in common_files:
            ...
            for idx, ocr_row in missing_group.iterrows():
                ...
                results.append({
                    ...
                    'OCR_Asset':       ocr_row['Asset'],
                    'OCR_Creative':    ocr_row['Creative'],
                    'OCR_Text':        ocr_row['cleaned_text'],
    ...
    results_not_in_matches['Guid_ID']           = [uuid.uuid4().hex for _ in range(len(results_not_in_matches))]
