...
sys.path.insert(0, r'Z:\Shared\OCT\LDN\FSE\FSEData\Technology Team\Charlie Reed\SportsSight\Post-Processing\Matchroom\WST')
...
inputFile    = r"Z:\Shared\OCT\LDN\FSE\FSEData\Technology Team\Charlie Reed\SportsSight\Post-Processing\Matchroom\WST\SportsSight - Brand Asset Methodology (WST) v5.xlsx"
output_folder = r"Z:\Shared\OCT\LDN\FSE\FSEData\Technology Team\Charlie Reed\SportsSight\Post-Processing\Matchroom\WST"
...
listOfEvents = [
'20260427_WST_WC_Day10Afternoon',
'20260426_WST_WC_Day9Evening',
'20260419_WST_WC_Day2Afternoon',
'20260421_WST_WC_Day4Afternoon',
'20260420_WST_WC_Day3Evening',
# '20260423_WST_WC_Day6Afternoon',
'20260422_WST_WC_Day5Evening',
'20260429_WST_WC_Day12Afternoon',
'20260428_WST_WC_Day11Evening',
'20260501_WST_WC_Day14Afternoon',
'20260425_WST_WC_Day8Afternoon',
'20260424_WST_WC_Day7Evening',
'20260504_WST_WC_Day17Evening',
'20260502_WST_WC_Day15Evening',
'20260418_WST_WC_Day1Evening'
]
...
unassigned_brand_asset_map = {
    'PensionBee': 'Tableside Branding',
    'Victorian Plumbing':       'Tableside Branding'
    }

# Pass 2: (IC prediction, Brand) -> Asset for still-Unassigned rows
unassigned_ic_asset_map = {
    # ('Distant Above',    'Sheffield Inspires'): 'Vomitory',
    ('Main Shot - Zoom', 'Strachan'):     'Table Logo',
    ('Player Close Up',  'Strachan'):     'Referee Jacket',
    ('Table End',        'Strachan'):     'Referee Jacket',
    ('Table Side',       'Strachan'):     'Referee Jacket',
}
...
if not ocr_coords.empty:
    if input("Have you already processed the TVGIs based on coordinates? (Y/N): ").upper() == 'N':
        ...
        ocr_tvgi_coords = coord.ocr_coords_toSQL_proc(
            ...
            iteration=iteration,
            group_events=True,
            brands=['Barclays', 'Barclays WSL', 'Barclays Solus'],
            cleaned_text_list=['Barclays', 'Barclays WSL', 'Barclays Solus'],
...
def exposurePerEvent(match):
    ...
    if brandAsset_method['AssetOnly'].notna().any():
        ...
        """, sqlServer, sqlDatabase)
        # assetResults['Box_Size_Perc'] = assetResults['Width'] * assetResults['Height'] / imageSize
    ...
    # Always fetch IC results regardless of methodology
    try:
...
all_results.to_csv(
    r'Z:\Shared\OCT\LDN\FSE\FSEData\Technology Team\Ernest Teh\SportsSight\pls3.csv',
    index=False
)
